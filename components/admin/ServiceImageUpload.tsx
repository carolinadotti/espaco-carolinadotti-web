...
export default function ServiceImageUpload({ serviceId, currentUrl, onSuccess }: ServiceImageUploadProps) {
  ...
  async function handleConfirm() {
    ...
    try {
      ...
      fd.append("file", blob, "service.jpg")
      fd.append("type", `service-${serviceId}`)
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-4">
        <div className="w-20 h-24 rounded overflow-hidden bg-muted border shrink-0">
          {currentUrl ? (
      ...
      <p className="text-xs text-muted-foreground">Proporção 4:5. Será convertida para WebP otimizado.</p>

      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-xl">
          <DialogHeader><DialogTitle>Recortar imagem do serviço</DialogTitle></DialogHeader>
          {src && (
